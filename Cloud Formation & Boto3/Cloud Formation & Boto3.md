# Cloud Formation & Boto3

- CloudFormation is an AWS service which enables you to create, manage, configure, replicate and delete AWS resources easily and rapidly using templates
...
- `Stacks and templates` are the main components of AWS CloudFormation
- Template is `JSON or YAML` formatted
- Templates extensions should be `.json, .yaml, .template or .txt`
- A `Stack` can be single EC2 instance or a more complex VPC configuration including hundreds of resources.
...
- Aws doesn't require any additional fee for Cloudformation, but you can pay only resources your use.
...
- `Template is ready:` Select this option, if you have already created your template.
- `Use a sample template:` AWS provides a collection of sample templates for users to build their stacks easily.
- `Create template in Designer:` AWS CloudFormation Designer is a graphical user interface which enables you to build your templates using a drag and drop menu
...
- I attached this template below
```
...
- It enables you to create, use, update, and delete AWS resources with your Python scripts.
...
- pip install boto3
```
` Note: To be able to use boto3, you need to setup your credentials.`
...
- Lets write simple script interacting with AWS S3
- Open your Python interpreter and write code.
- First you need to import it `import boto3`
- Then write other commands
...
s3.Bucket('my-bucket').put_object(Key='test.jpg', Body=data) #my bucket=bucket name
```